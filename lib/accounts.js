...
module.exports = function (session) {
  ...
  return {
    ...
    /**
     * Sends a keep-alive request to Betfair to keep session open.
     * Italian Exchange: 20 minutes. International Exchange: 24 hours.
     * A timer can be implemented by the user.
     * @param cb
     */
    ...
    listCurrencyRates: function (fromCurrency, cb) {
      requestBetFair.sendAccount(session, {
        ...
        data: {fromCurrency: fromCurrency || 'GBP'}
      }, cb);
    },
